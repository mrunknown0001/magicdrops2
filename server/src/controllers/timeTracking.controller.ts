 ...
 */
export const createTimeEntryForApprovedTask = async (
 ...
 */
export const getEmployeeTimeEntries = async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 * @param res - Express response object
 */
export const calculateWorkedHours = async (req: Request, res: Response): Promise<void> => {
  try {
    const { employeeId } = req.params;
...
export const createTimeEntry = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const timeEntry = await createTimeEntryForApprovedTask(taskAssignmentId, approvedBy);
