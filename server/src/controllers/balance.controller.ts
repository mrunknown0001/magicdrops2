 ...
 */
export const getWorkerBalance = async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
export const getWorkerTransactions = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { workerId } = req.params;
    ...
    if (type && ['task_payment', 'payout', 'adjustment'].includes(type as string)) {
 ...
 */
export const approveTaskPayment = async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
export const createPayoutRequest = async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
export const processPayoutRequest = async (req: Request, res: Response, next: NextFunction) => {
  try {
 ...
 */
export const getAllPayoutRequests = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    if (status && ['pending', 'approved', 'rejected', 'paid'].includes(status as string)) {
 ...
 */
async function updateWorkerBalance(workerId: string, amountChange: number) {
  try {
    // Get current balance
